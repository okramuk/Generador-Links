...
<tr>
	<td colspan="2"><center><input name="clave" type="button" value="Cambiar Clave" onClick="cambiarClave(document.form1.old_passwd.value, document.form1.new_passwd.value, document.form1.new_passwd_confirm.value, document.form1.type_user.value)"></center></td>
</tr>
<tr>
<?php
